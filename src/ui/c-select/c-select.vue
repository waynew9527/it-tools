      ...
      >
        <div flex-1 truncate>
          <slot name="displayed-value">
            <input v-if="searchable && isOpen" ref="searchInputRef" v-model="searchQuery" class="search-input" type="text" placeholder="Search..." w-full color-current lh-normal @input="onSearchInput">
